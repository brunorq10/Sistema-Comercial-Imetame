...
// GET /api/faturamento/multas/:multaId/historico
export async function GET(_req: NextRequest, { params }: { params: { multaId: string } }) {
  ...
  const historico = await prisma.multaPenalidadeHistorico.findMany({
    where: { multa_id: id },
