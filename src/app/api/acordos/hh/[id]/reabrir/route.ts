...
// POST — reabre uma Obra fechada, mediante justificativa. Mesmo padrão de "Reabrir Parada".
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  { const _n = await exigirTitularContrato(session, contratoId, 'acordos.obras.reabrir'); if (_n) return _n }
