...
// POST — fecha o acompanhamento de HH da Obra (consolida os lançamentos;
// nada mais pode ser ajustado até reabrir). Mesmo padrão de "Fechar Parada".
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  if (contrato.hh_fechada_em) return NextResponse.json({ data: null, error: 'Esta Obra já está fechada' }, { status: 409 })
